...
class TestAIEngine(unittest.TestCase):
    ...
    @patch('src.ai.engine.find_best_move_iterative_deepening')
    @patch('src.ai.engine.clear_transposition_table')
    def test_start_calculation_normal_flow(self, mock_clear_tt, mock_find_best_move):
        ...
        on_complete_callback.assert_called_once_with(expected_move, ANY)
    ...
    def test_progress_callback_is_called(self, mock_find_best_move):
        ...
        def ai_with_progress(*args, **kwargs):
            ...
            if progress_callback:
                progress_callback(1, 0.0, ((1,1), (2,2)), [], None)
                progress_callback(2, 0.0, ((1,1), (2,2)), [], None)
            return ((1,1), (2,2))
        ...
        progress_callback.assert_any_call(1, 0.0, ((1,1), (2,2)), [], None)
        progress_callback.assert_any_call(2, 0.0, ((1,1), (2,2)), [], None)
    ...
    def test_state_is_deep_copied(self, mock_find_best_move):
        ...
        # 在主线程中，立即修改原始的game_state的当前玩家标识
        game_state.current_player = 99 # 用一个不存在的玩家ID来标记修改
        ...
        # 关键断言：断言线程中的状态，没有我们后来做的修改
        self.assertNotEqual(state_in_thread.current_player, 99)
