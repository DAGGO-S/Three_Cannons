...
#define __PYX_HAVE__core__constants
#define __PYX_HAVE_API__core__constants
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
#define __Pyx_MODULE_NAME "core.constants"
extern int __pyx_module_is_main_core__constants;
int __pyx_module_is_main_core__constants = 0;

/* Implementation of "core.constants" */
...
__Pyx_RefNannySetupContext("PyInit_constants", 0);
  ...
  if (__pyx_module_is_main_core__constants) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "core.constants")) {
      if (unlikely((PyDict_SetItemString(modules, "core.constants", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
  ...
  /* "core/constants.pyx":1
 * # core/constants.pyx             # <<<<<<<<<<<<<<
 * #  constants  Python  import
*/
  ...
  /*--- Wrapped vars code ---*/
  {
    PyObject* wrapped = __Pyx_PyLong_From___pyx_anon_enum(__pyx_e_4core_9constants_BOARD_COLS);
    if (unlikely(!wrapped)) __PYX_ERR(1, 10, __pyx_L1_error)
    if (PyObject_SetAttrString(__pyx_m, "BOARD_COLS", wrapped) < 0) __PYX_ERR(1, 10, __pyx_L1_error);
  }
  {
    PyObject* wrapped = __Pyx_PyLong_From___pyx_anon_enum(__pyx_e_4core_9constants_BOARD_ROWS);
    if (unlikely(!wrapped)) __PYX_ERR(1, 9, __pyx_L1_error)
    if (PyObject_SetAttrString(__pyx_m, "BOARD_ROWS", wrapped) < 0) __PYX_ERR(1, 9, __pyx_L1_error);
  }
  {
    PyObject* wrapped = __Pyx_PyLong_From___pyx_anon_enum(__pyx_e_4core_9constants_CANNON);
    if (unlikely(!wrapped)) __PYX_ERR(1, 6, __pyx_L1_error)
    if (PyObject_SetAttrString(__pyx_m, "CANNON", wrapped) < 0) __PYX_ERR(1, 6, __pyx_L1_error);
  }
  {
    PyObject* wrapped = __Pyx_PyLong_From___pyx_anon_enum(__pyx_e_4core_9constants_DRAW);
    if (unlikely(!wrapped)) __PYX_ERR(1, 7, __pyx_L1_error)
    if (PyObject_SetAttrString(__pyx_m, "DRAW", wrapped) < 0) __PYX_ERR(1, 7, __pyx_L1_error);
  }
  {
    PyObject* wrapped = __Pyx_PyLong_From___pyx_anon_enum(__pyx_e_4core_9constants_EMPTY);
    if (unlikely(!wrapped)) __PYX_ERR(1, 4, __pyx_L1_error)
    if (PyObject_SetAttrString(__pyx_m, "EMPTY", wrapped) < 0) __PYX_ERR(1, 4, __pyx_L1_error);
  }
  {
    PyObject* wrapped = __Pyx_PyLong_From___pyx_anon_enum(__pyx_e_4core_9constants_NO_WINNER);
    if (unlikely(!wrapped)) __PYX_ERR(1, 8, __pyx_L1_error)
    if (PyObject_SetAttrString(__pyx_m, "NO_WINNER", wrapped) < 0) __PYX_ERR(1, 8, __pyx_L1_error);
  }
  {
    PyObject* wrapped = __Pyx_PyLong_From___pyx_anon_enum(__pyx_e_4core_9constants_SOLDIER);
    if (unlikely(!wrapped)) __PYX_ERR(1, 5, __pyx_L1_error)
    if (PyObject_SetAttrString(__pyx_m, "SOLDIER", wrapped) < 0) __PYX_ERR(1, 5, __pyx_L1_error);
  }
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init core.constants", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init core.constants");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
